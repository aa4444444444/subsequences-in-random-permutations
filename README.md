...
2.1) https://github.com/InductiveComputerScience/pbPlots/tree/master/Cpp (The four files you need are pbPlots.cpp, pbPlots.hpp,       supportLib.cpp, and supportLib.hpp)
2.2) If you decide to name the directory something other than tplibs, you will have to make changes to main.cpp and the Makefile
...
4.1) You will likely get some warnings for the pbPlots files since the Makefile uses the -Wall flag. This is fine, you can ignore it.
